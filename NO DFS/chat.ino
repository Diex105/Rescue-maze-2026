...
#define TURN_SPEED_MAX 210
#define TURN_SPEED_MIN 170
...
void giro90Der() { giroRelativo(90.0); }
void giro90Izq() { giroRelativo(-90.0); }
...
void acomodarObstaculoSimple(String lado, float distanciaAvanzada) {
  ...
  float anguloOriginal = readHeadingAvg(0);
