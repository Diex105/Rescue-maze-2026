...
ResultadoMovimiento avanzar_optimizado(int DISTANCIA_CM) {
  ...
  bool detectoAzulEnTrayecto = false;
  ...
  delay(200);
  if (detectoAzulEnTrayecto) return MOV_AZUL;
  return MOV_OK;
}
...
bool enInicio() {
  return mapa[nodoActual].x == 0 && mapa[nodoActual].y == 0;
}
