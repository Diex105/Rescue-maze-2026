# ============================================================
# OPENMV - SOLO DETECCION DE LETRAS CON MODELO FOMO
# Comunicacion por 2 pines:
#   P6 = DAC (voltaje segun letra)
#   P4 = pulso digital a Teensy
# ============================================================
...
def poner_voltaje_letra(letra):
    if letra == "phi":
        ...
        dac.write(1650)    # 1.65 V
        return 1.33
    elif letra == "omega":
        dac.write(3723)    # 3.00 V
        return 3.00
    return None

def enviar_senal(dato):
    global senal_silence_until
